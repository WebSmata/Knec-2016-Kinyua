<?php include JS_THEME."js_header.php"; ?>
	<div id="site_content">	
		...
		<?php $js_db_query = "SELECT * FROM js_employee ORDER BY employeeid DESC LIMIT 20";
		...
		<br>
          ...
          <br><hr><br>
			<div class="main_content" align="center">
			   ...
			   <table class="tt_tb">
		        ...
		        <tr onclick="location='index.php?page=employee_view&amp;js_employeeid=<?php echo $row['employeeid'] ?>'">
				   <td><img class="iconic" src="js_media/<?php echo $row['employee_avatar'] ?>" /></td>
			...
			<?php } ?>
					...
					<h1><?php echo $database->js_num_rows( $js_db_query ) ?> Employees
